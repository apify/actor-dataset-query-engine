...
#   timestamp: 2025-03-19T20:06:40+00:00
...
class DatasetQueryEngine(BaseModel):
    query: str = Field(
        ...,
    ...
    modelName: Optional[Literal['gpt-4o-mini', 'gpt-4o', 'o3-mini']] = Field(
        'gpt-4o-mini',
